...
def eoss_data_received(update: Update, context: CallbackContext) -> None:
    """
    Method running, when all data on EOSS is received.
    Packs pool and all data and sends it to required telegram chat, where voters are.
    :param update:
    :param context:
    :return:
    """
